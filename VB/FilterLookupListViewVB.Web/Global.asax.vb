...
Imports FilterLookupListViewVB.Module
...
#End If
    ...
    Protected Sub Session_Start(ByVal sender As Object, ByVal e As EventArgs)
        WebApplication.SetInstance(Session, New FilterLookupListViewVBAspNetApplication())
...
#End If
		...
		'Dim _middleTierClientApplicationConfigurator As DevExpress.ExpressApp.MiddleTier.MiddleTierClientApplicationConfigurator = New DevExpress.ExpressApp.MiddleTier.MiddleTierClientApplicationConfigurator(WebApplication.Instance)
