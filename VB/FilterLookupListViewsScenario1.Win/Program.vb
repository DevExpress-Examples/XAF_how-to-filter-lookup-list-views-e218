...
Imports FilterLookupListViewsScenario1.Win
...
Public Class Program
    ...
    Public Shared Sub Main(ByVal arguments() As String)
        ...
        Dim _application As FilterLookupListViewsScenario1WindowsFormsApplication = New FilterLookupListViewsScenario1WindowsFormsApplication()
